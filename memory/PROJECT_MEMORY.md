# Makergy Project One Pitch - Working Memory
...
## Timeline Target
- Best-case delivery: 24 months from funding.
- Target completion + exit: Q4 2027.

## Team (Makergy Core)
- David Gosse - Chief Visionary Officer.
- Mardie Engelhardt - Design Principal & Creative Director.
- Michael Hofer - Lead Systems & BIM Architect.
- Anthony Holzapple - General Contractor & Project Director.
...
## Open Data Needed
- Market comps (address, price/SF, DOM, finish tier).
- Lot address + entitlement status + permitting timeline.
- Final cost validation (soft costs, contingency, selling costs).
- Confirmation on pref rate disclosure and fee disclosures.
- Product references for signature design features (stone, lighting, plumbing, AV).
